...
const About = () => {
  return (
    <div className="container pb-3 border rounded">
      ...
      <p>Hi!<br />My name is Thomas and I'm thrilled to have you visiting my website!<br />As you probably can guess I am a Web Developer. I am currently enrolled in a Bootcamp by Altcademy where I am learning to become a Fullstack Web-Developer!<br /> So far I have learned a lot about front-end and have become very secure in this craft. <br /> Apart from being Web-Developer I am also a Music Producer.<br /> 
      <br />
